...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 15:50:12 2019
...
cv2.namedWindow("input.jpg",cv2.WINDOW_NORMAL)
cv2.imshow("input.jpg", orig)
cv2.namedWindow("input Gray.jpg",cv2.WINDOW_NORMAL)
cv2.imshow("input Gray.jpg", gray)
cv2.namedWindow("input Blurred.jpg",cv2.WINDOW_NORMAL)
cv2.imshow("input Blurred.jpg", blurred)
cv2.namedWindow("input Edged.jpg",cv2.WINDOW_NORMAL)
cv2.imshow("input Edged.jpg", orig_edged)
